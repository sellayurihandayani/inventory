...
<table class="table table-striped table-sm">
    <tr>
        ...
        <td rowspan="3"
            style="width: 50%; font-weight: bold; color: red; font-size: 20pt; text-align: center; vertical-align: middle;" id="lbTotalHarga">
    ...
    <tr>
        ...
        <td style="width: 2%;">:</td>
        <td style="width: 28%;"><?= $namapelanggan; ?></td>
    </tr>
</table>
        ...
        $('#tombolEditItem').click(function (e) { 
            ...
            $.ajax({
                ...
                success: function (response) {
                    if(response.sukses){
                        Swal.fire({
                            'icon' : 'success', 'title' : 'Berhasil', 'text' : response.sukses
                        });
                        tampilDataDetail();
                        ambilTotalHarga();
                        kosong();
