        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-1">
                ...
                <div class="input-group">
                    <button type="button" class="btn btn-sm btn-primary" title="Tambah Item" id="tombolTambahItem">
                    ...
                    &nbsp;
                    <button style="display: none;" type="button" class="btn btn-sm btn-dark" title="Reload Item" id="tombolReload">
        ...
        $('#tombolTambahItem').click(function (e) { 
            ...
            if(faktur.length == 0){
                Swal.fire({
                    ...
                    footer: '<a href="">Silahkan Isi Kembali</a>',
                })
